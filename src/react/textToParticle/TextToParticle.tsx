...
const TextToParticleComponent = forwardRef<TextToParticleRef, TextToParticleProps>((props, ref) => {
  ...
  return <div ref={containerRef} className={props.className} style={defaultStyle} />;
});
